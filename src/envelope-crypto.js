 ...
 *     type: "encrypted",
 *     from: "agent-2",
 *     to: "agent-5",           // or conversationId for group
 *     ttl: 3,
 *     path: ["agent-2"],
 *     timestamp: ...,
 *     encrypted: {
 ...
 *       senderPub: "<base64>",
 *       recipients: {
 *         "agent-5": { ciphertext, nonce, tag },
 *         "agent-7": { ciphertext, nonce, tag }
 *       }
 *     }
 *   }
 *
...
const KEY_DIR = path.join(os.homedir(), '.agent-config', 'pulse-keys');
